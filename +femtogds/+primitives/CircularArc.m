classdef CircularArc < femtogds.core.GeomFeature
    ...
    methods
        ...
        function val = get.center(obj)
            val = obj.get_param("center", femtogds.types.Vertices([0, 0]));
        end

        function set.radius(obj, val)
            p = femtogds.core.GeomFeature.coerce_parameter(val, "", unit="nm");
        ...
        function val = get.radius(obj)
            val = obj.get_param("radius", femtogds.types.Parameter(1, "", unit="nm"));
        end
        ...
        function val = get.start_angle(obj)
            val = obj.get_param("start_angle", femtogds.types.Parameter(0, "", unit="deg"));
        end
        ...
        function val = get.end_angle(obj)
            val = obj.get_param("end_angle", femtogds.types.Parameter(90, "", unit="deg"));
        end
        ...
        function set.npoints(obj, val)
            ...
            obj.set_param("npoints", femtogds.types.Parameter(n, "", unit=""));
        end
