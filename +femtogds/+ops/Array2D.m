classdef Array2D < femtogds.core.GeomFeature
    ...
    methods
        ...
        function set.ncopies_x(obj, val)
            obj.set_param("ncopies_x", femtogds.core.GeomFeature.coerce_parameter(val, "ncopies_x", unit=""));
        end
        ...
        function set.ncopies_y(obj, val)
            obj.set_param("ncopies_y", femtogds.core.GeomFeature.coerce_parameter(val, "ncopies_y", unit=""));
        end
        ...
        function set.delta_x(obj, val)
            obj.set_param("delta_x", femtogds.core.GeomFeature.coerce_vertices(val));
        end
        ...
        function set.delta_y(obj, val)
            obj.set_param("delta_y", femtogds.core.GeomFeature.coerce_vertices(val));
        end
