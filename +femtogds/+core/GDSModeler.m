classdef GDSModeler < femtogds.core.Klayout
    properties
        pylayout
        pycell
        shapes
    ...
    methods
        ...
        function mark = add_alignment_mark(obj, args)
            ...
            mark = femtogds.primitives.Polygon;
            ...
            mark.vertices = femtogds.types.Vertices(Utilities.get_vertices_from_klayout(mark.pgon_py));
        end
        function two_inch_wafer = add_two_inch_wafer(obj)
            ...
            two_inch_wafer = femtogds.primitives.Polygon;
            ...
            two_inch_wafer.vertices = femtogds.types.Vertices(Utilities.get_vertices_from_klayout(two_inch_wafer.pgon_py));
        end
