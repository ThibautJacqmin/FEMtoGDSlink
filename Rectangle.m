classdef Rectangle < GeomFeature
    ...
    methods
        ...
        function set.position(obj, val)
            obj.set_param("position", GeomFeature.coerce_vertices(val));
        end
        ...
        function val = get.center(obj)
            ...
            if obj.base == "center"
                ...
                val = Vertices(pos + [obj.width_value()/2, obj.height_value()/2]);
            end
        end
        ...
        function set.width(obj, val)
            obj.set_param("width", GeomFeature.coerce_parameter(val, "width"));
        end
        ...
        function set.height(obj, val)
            obj.set_param("height", GeomFeature.coerce_parameter(val, "height"));
        end
