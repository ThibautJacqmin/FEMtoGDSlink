classdef Circle < GeomFeature
    ...
    methods
        ...
        function val = get.radius(obj)
            val = obj.get_param("radius", Parameter(1, "radius"));
        end
        ...
        function val = get.angle(obj)
            val = obj.get_param("angle", Parameter(360, "", unit="deg"));
        end
        ...
        function val = get.rotation(obj)
            val = obj.get_param("rotation", Parameter(0, "", unit="deg"));
        end
