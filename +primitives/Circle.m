classdef Circle < core.GeomFeature
    ...
    methods
        ...
        function set.base(obj, val)
            new_base = primitives.Circle.normalize_base(val);
        ...
        function val = get.radius(obj)
            val = obj.get_param("radius", types.Parameter(1, "radius"));
        end
        ...
        function val = get.angle(obj)
            val = obj.get_param("angle", types.Parameter(360, "", unit="deg"));
        end

        function set.rotation(obj, val)
            obj.set_param("rotation", core.GeomFeature.coerce_parameter(val, "", unit="deg"));
        end

        function val = get.rotation(obj)
            val = obj.get_param("rotation", types.Parameter(0, "", unit="deg"));
        end
