classdef Box < Polygon
    ...
    methods
        function obj = Box(args)
            arguments
                args.center types.Vertices
                args.width types.Parameter
                args.height types.Parameter
                args.left types.Parameter
                args.right types.Parameter
                args.top types.Parameter
                args.bottom types.Parameter
                args.top_left types.Vertices
                args.top_right types.Vertices
                args.bottom_left types.Vertices
                args.bottom_right types.Vertices
            ...
            elseif isscalar(intersect(fields, "vertices"))
                obj.pgon_py = obj.pya.Polygon.from_s(...
                    core.KlayoutCodec.vertices_to_klayout_string(args.vertices.value));
        ...
        function l = get.left(obj)
            l = types.Parameter(obj.vertices.value(1, 1), "left");
        end
        function r = get.right(obj)
            r = types.Parameter(obj.vertices.value(3, 1), "right");
        end
        function b = get.bottom(obj)
            b = types.Parameter(obj.vertices.value(1, 2), "bottom");
        end
        function t = get.top(obj)
            t = types.Parameter(obj.vertices.value(3, 2), "top");
        end
        ...
        function fillet_polygons = get_fillets(obj)
            ...
            if obj.comsol_flag
                fillet_polygon = primitives.Polygon(vertices=types.Vertices(fillet_points), comsol_modeler=obj.comsol_modeler);
            else
                fillet_polygon = primitives.Polygon(vertices=types.Vertices(fillet_points));
            end
        ...
        function y = copy(obj)      
            ...
            y = primitives.Box(vertices=types.Vertices(obj.vertices.array, obj.vertices.prefactor), comsol_modeler=obj.comsol_modeler);
        end
    end
    methods
        function set_center_height_width(obj, center, height, width)
            ...
            t = center(2)+height/2;
            b = center(2)-height/2;
            obj.vertices = types.Vertices([l, b; l, t; r, t; r, b]);
            obj.pgon_py = obj.pya.Polygon.from_s(...
                core.KlayoutCodec.vertices_to_klayout_string(obj.vertices.value));
        ...
        function set_bottomleft_topright(obj, bottom_left, top_right)
            ...
            obj.vertices = types.Vertices([l, b; l, t; r, t; r, b]);
            obj.pgon_py = obj.pya.Polygon.from_s(...
                core.KlayoutCodec.vertices_to_klayout_string(vertices.value));
            obj.set_comsol_rectangle(l, r, t, b);
        end
