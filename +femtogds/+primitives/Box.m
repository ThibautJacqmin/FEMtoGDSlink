classdef Box < Polygon
    ...
    methods
        function obj = Box(args)
            arguments
                args.center femtogds.types.Vertices
                args.width femtogds.types.Parameter
                args.height femtogds.types.Parameter
                args.left femtogds.types.Parameter
                args.right femtogds.types.Parameter
                args.top femtogds.types.Parameter
                args.bottom femtogds.types.Parameter
                args.top_left femtogds.types.Vertices
                args.top_right femtogds.types.Vertices
                args.bottom_left femtogds.types.Vertices
                args.bottom_right femtogds.types.Vertices
                args.vertices femtogds.types.Vertices
                args.fillet_width femtogds.types.Parameter = femtogds.types.Parameter(1, "")
                args.fillet_height femtogds.types.Parameter = femtogds.types.Parameter(1, "")
        ...
        function l = get.left(obj)
            l = femtogds.types.Parameter(obj.vertices.value(1, 1), "left");
        end
        function r = get.right(obj)
            r = femtogds.types.Parameter(obj.vertices.value(3, 1), "right");
        end
        function b = get.bottom(obj)
            b = femtogds.types.Parameter(obj.vertices.value(1, 2), "bottom");
        end
        function t = get.top(obj)
            t = femtogds.types.Parameter(obj.vertices.value(3, 2), "top");
        end
    ...
    methods
        function set_center_height_width(obj, center, height, width)
            ...
            t = center(2)+height/2;
            b = center(2)-height/2;
            obj.vertices = femtogds.types.Vertices([l, b; l, t; r, t; r, b]);
            obj.pgon_py = obj.pya.Polygon.from_s(...
