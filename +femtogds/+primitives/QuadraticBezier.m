classdef QuadraticBezier < femtogds.core.GeomFeature
    ...
    methods
        ...
        function val = get.p0(obj)
            val = obj.get_param("p0", femtogds.types.Vertices([0, 0]));
        end
        ...
        function val = get.p1(obj)
            val = obj.get_param("p1", femtogds.types.Vertices([0.5, 1]));
        end
        ...
        function val = get.p2(obj)
            val = obj.get_param("p2", femtogds.types.Vertices([1, 0]));
        end
        ...
        function val = get.npoints(obj)
            val = obj.get_param("npoints", femtogds.types.Parameter(96, "", unit=""));
        end
