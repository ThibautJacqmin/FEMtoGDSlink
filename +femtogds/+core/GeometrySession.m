classdef GeometrySession < handle
    ...
    methods
        function obj = GeometrySession(args)
            ...
            if enable_comsol
                ...
                elseif args.reuse_comsol_gui
                    obj.comsol = femtogds.core.ComsolModeler.shared(reset=true);
                else
                    obj.comsol = femtogds.core.ComsolModeler;
                end
            else
                obj.comsol = [];
            end
            ...
            obj.layers = dictionary(string.empty(0,1), femtogds.core.LayerSpec.empty(0,1));
            obj.nodes = {};
        ...
        function layer = resolve_layer(obj, ref)
            % Resolve layer input from femtogds.core.LayerSpec instance or layer name.
            if isa(ref, 'femtogds.core.LayerSpec')
                layer = ref;
                return;
            end
            ...
            error("Layer reference must be a femtogds.core.LayerSpec or layer name.");
        end
        ...
        function export_gds(obj, filename)
            ...
            if isempty(obj.gds_backend)
                obj.gds_backend = femtogds.core.GdsBackend(obj);
            end
