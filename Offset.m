classdef Offset < GeomFeature
    ...
    methods
        ...
        function set.distance(obj, val)
            p = GeomFeature.coerce_parameter(val, "distance");
        ...
        function val = get.distance(obj)
            val = obj.get_param("distance", Parameter(0, "", unit="nm"));
        end
    ...
    methods (Static, Access=private)
        function [ctx, target, args] = parse_inputs(varargin)
            [ctx, target, nv] = GeomFeature.parse_target_context("Offset", varargin{:});
