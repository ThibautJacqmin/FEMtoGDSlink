classdef CubicBezier < GeomFeature
    ...
    methods
        ...
        function val = get.p0(obj)
            val = obj.get_param("p0", Vertices([0, 0]));
        end
        ...
        function val = get.p1(obj)
            val = obj.get_param("p1", Vertices([1/3, 1]));
        end
        ...
        function val = get.p2(obj)
            val = obj.get_param("p2", Vertices([2/3, -1]));
        end
        ...
        function val = get.p3(obj)
            val = obj.get_param("p3", Vertices([1, 0]));
        end
